...
- `package-lock.json` — npm lock file (~151312 tok)
- `package.json` — Node.js package manifest (~621 tok)
...
- `release.yml` — CI: Release (~871 tok)

## .superpowers/brainstorm/11890-1774685052/content/

- `final-mockup-v2.html` (~1187 tok)
- `final-mockup-v3.html` (~1456 tok)
- `final-mockup-v4.html` (~1427 tok)
- `final-mockup.html` (~1311 tok)
- `layout-direction.html` (~1400 tok)
- `mascot-choice.html` (~932 tok)
- `waiting-1.html` (~39 tok)
- `waiting-2.html` (~41 tok)

## .superpowers/brainstorm/11890-1774685052/state/

- `server-stopped` (~14 tok)
- `server.log` (~884 tok)
- `server.pid` (~2 tok)

## .superpowers/brainstorm/61903-1774699566/content/

- `controls-placement.html` (~1385 tok)
- `folder-management.html` (~1530 tok)
- `library-design.html` (~3493 tok)
- `search-behavior.html` — Declares in (~1298 tok)
- `waiting-1.html` (~39 tok)
- `waiting-2.html` (~39 tok)
- `waiting-3.html` (~39 tok)

## .superpowers/brainstorm/61903-1774699566/state/

- `server-stopped` (~14 tok)
- `server.log` (~1417 tok)
- `server.pid` (~2 tok)

## .superpowers/brainstorm/64476-1774774582/content/

- `layout-final.html` (~1427 tok)
- `layout-redesign-v2.html` (~1089 tok)
- `layout-redesign.html` — Declares indicator (~1315 tok)

## .superpowers/brainstorm/64476-1774774582/state/

- `server-stopped` (~14 tok)
- `server.log` (~234 tok)
- `server.pid` (~2 tok)

## .superpowers/brainstorm/66818-1774779433/content/

- `settings-tabs.html` — Declares showTab (~2810 tok)

## .superpowers/brainstorm/66818-1774779433/state/

- `server-info` (~94 tok)

## .superpowers/brainstorm/9152-1774656292/content/

- `library-layout.html` (~1685 tok)
- `panel-layout.html` (~1754 tok)
- `waiting-1.html` (~39 tok)

## .superpowers/brainstorm/9152-1774656292/state/
...
- `2026-03-27-github-release-workflow.md` — GitHub Release Workflow Implementation Plan (~4895 tok)
- `2026-03-28-ai-notes-summary.md` — AI Notes & Video Summary Implementation Plan (~15811 tok)
- `2026-03-28-auto-classification.md` — Auto-Classification Implementation Plan (~11978 tok)
- `2026-03-28-browser-layout-redesign.md` — Browser Layout Redesign Implementation Plan (~5094 tok)
- `2026-03-28-debug-logging.md` — Debug Logging & Debug Tab Implementation Plan (~7986 tok)
...
- `2026-03-27-video-downloader-design.md` — Video Downloader App — Design Spec (~1461 tok)
- `2026-03-28-ai-notes-summary-design.md` — AI Notes & Video Summary Feature Design (~3588 tok)
- `2026-03-28-auto-classification-design.md` — Auto-Classification Feature Design (~1765 tok)
- `2026-03-28-browser-layout-redesign.md` — Browser Tab Layout Redesign (~777 tok)
- `2026-03-28-library-detail-panel-design.md` — Library Detail Panel — Design Spec (~1087 tok)
...
- `download-ytdlp.js` — https: download (~968 tok)
- `notarize.js` — Called by electron-builder as afterSign hook. (~239 tok)
...
- `Versions.jsx` — Versions — uses useState (~117 tok)
- `VideoPlayer.jsx` — SPEEDS — uses useRef, useState, useEffect, useCallback (~3364 tok)

## src/renderer/src/components/icons/

- `ContentTypeIcon.jsx` — ContentTypeIcon (~427 tok)

## src/renderer/src/hooks/

- `useIpcEvents.js` — Exports useIpcEvents (~508 tok)
...
- `pageCapture.js` — Convert image URLs to base64 data URIs (~1317 tok)
...
- `browser-notes-flow.test.jsx` — Helper to set browserActiveChapter on the active tab (~3249 tok)

## tests/main/

- `.gitkeep` (~0 tok)
- `ai-client.test.js` — Declares mockFetch (~1342 tok)
- `ai-summarizer.test.js` — Declares baseConfig (~1032 tok)
- `auto-classifier.test.js` — Declares result (~2462 tok)
- `config-store.test.js` — Declares cfg (~692 tok)
