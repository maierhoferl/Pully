...
import { captureFromUrl } from '../utils/pageCapture'

/**
 * LivePageView fetches and renders a live page from a URL
 * Uses pageCapture.captureFromUrl to extract and convert to markdown
 */
export function LivePageView({ url, onClose }) {
  ...
  useEffect(() => {
    async function fetchLiveContent() {
      ...
      try {
        ...
        const result = await captureFromUrl(url)
